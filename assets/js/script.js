...
function checkAnswer() {
  ...
  if (isCorrect) {
    alert("Hey! You got it righht! :D");
    incrementScore();
  } else {
    alert(
      `Aww you answered ${userAnswer}. The correct answer was ${calculatedAnswer[0]}!`
    );
 ...
 * directly from teh dom, and returns the correct answer.
 */
